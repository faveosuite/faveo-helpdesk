...
return [
    ...
    */
    ...
    'workflow_rule_incomplete'      => 'Please complete every workflow rule row.',
    'workflow_action_incomplete'    => 'Please select an action and its value for every workflow action row.',
    'rules'                         => 'Rules',
    'order'                         => 'Order',
    'condition'                     => 'Condition',
    'statement'                     => 'Statement',
    ...
    'max_attempt_executed' => 'Too many failed attempts. Please retry after :retry_after minute(s).',
