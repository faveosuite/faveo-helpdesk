...
return [
    ...
    */
    ...
    'workflow_rule_incomplete'      => 'Пожалуйста, заполните каждую строку правил рабочего процесса.',
    'workflow_action_incomplete'    => 'Пожалуйста, выберите действие и его значение для каждой строки действий рабочего процесса.',
    'rules'                         => 'Правила',
    'order'                         => 'Порядок',
    'condition'                     => 'Условие',
    'statement'                     => 'Состояние',
    ...
    'max_attempt_executed' => 'Слишком много неудачных попыток. Повторите попытку через :retry_after минут(ы).',
